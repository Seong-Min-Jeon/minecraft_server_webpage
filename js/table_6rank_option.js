function effect8() {
    ...
    var str =  '<div style="clear: both;" class="divTable">\
            <table border="1" bordercolor=#009879 class="settingTable">\
                <thead>\
                    <tr>\
                        <p><td colspan="3" align="center">6랭크에서 등장하는 효과</td></p>\
                    </tr>\
                </thead>\
                <tbody class="equip">\
                    <tr>\
                        <th rowspan="6">전투 경험치 증가</th>\
                        <td>전투 경험치 5% 증가</td>\
                        <td>1.281%</td>\
                    </tr>\
                    <tr>\
                    ...
                    <tr>\
                        <th rowspan="5">원거리 공격 시 마나 획득</th>\
                    ...
                    <tr>\
                        <th rowspan="5">근접 공격 시 확률로 10% 회복</th>\
                    ...
                    <tr>\
                        <th rowspan="5">원거리 공격 시 확률로 10% 회복</th>\
                    ...
                    <tr>\
                        <th rowspan="5">의문의 상자 발견 확률 증가</th>\
                    ...
                    <tr>\
                        <th rowspan="4">죽음에 이르는 피해를 입었을 때 확률로 체력 50% 회복</th>\
